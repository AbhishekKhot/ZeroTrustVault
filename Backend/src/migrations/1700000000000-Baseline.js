 ...
 */
export class Baseline1700000000000 {
    ...
    async up(queryRunner) {
        ...
        `);
        await queryRunner.query(`CREATE INDEX "idx_vault_items_user_id" ON "vault_items"("user_id")`);
        await queryRunner.query(`
...
//# sourceMappingURL=1700000000000-Baseline.js.map