 ...
 * anything real.
 */
const DUMMY_ARGON2_HASH = "$argon2id$v=19$m=65536,t=3,p=4$ZHVtbXlzYWx0ZHVtbXk$NpaP5K0jXNlmr5Bq2jyQWL2mT1KBxQsWqfNz0WjNt8E";
export class AuthService {
    userRepository;
    tokens;
    constructor(userRepository, tokens) {
