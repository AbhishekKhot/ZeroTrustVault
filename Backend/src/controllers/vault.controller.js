 ...
 */
export function createVaultController(service) {
    return {
        ...
        async update(request, reply) {
            ...
            if (!bodyParsed.success)
                throw new ValidationError("Invalid input", bodyParsed.error.issues);
            ...
            if (bodyParsed.data.iv !== undefined)
                args.iv = bodyParsed.data.iv;
